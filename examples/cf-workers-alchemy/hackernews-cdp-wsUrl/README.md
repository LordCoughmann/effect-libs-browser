# Hacker News CDP Scraper - Alchemy Cloudflare Worker

A Hacker News scraper running on Cloudflare Workers via [Alchemy](https://alchemy.run) using CDP with a custom WebSocket URL.
...
- Wrangler variant: [`../cf-workers/hackernews-cdp-wsUrl/`](../cf-workers/hackernews-cdp-wsUrl/) — same scraper, deployed via plain `wrangler` (no Alchemy)
