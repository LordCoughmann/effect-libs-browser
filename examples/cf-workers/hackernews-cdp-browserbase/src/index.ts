/**
 * Hacker News scraper - CDP with Browserbase provider on Cloudflare Workers.
 *
 * This example demonstrates how to use CDP (lightweight, no dependencies)
 * with Browserbase provider for browser automation.
 *
 ...
 *
 * See: https://docs.browserbase.com/reference/sessions
 */
...
<body>
	...
	<p>Cloudflare Workers example using CDP + Browserbase</p>
