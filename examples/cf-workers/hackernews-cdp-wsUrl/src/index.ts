/**
 * Hacker News scraper - CDP with custom URL on Cloudflare Workers.
 *
 ...
 *   - hackernews-cdp-steel
 *   - hackernews-cdp-browserbase
 */
...
const scrapeHackerNews = (cdpUrl: string) =>
  Effect.gen(function* () {
    ...
    const stories = yield* cdp.withConnection({ url: cdpUrl }, ({ page }) =>
      Effect.gen(function* () {
...
<body>
	...
	<p>Cloudflare Workers example using CDP with custom URL</p>
