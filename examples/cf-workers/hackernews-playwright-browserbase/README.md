# Hacker News Playwright Scraper - Browserbase

A Hacker News scraper running on Cloudflare Workers using Playwright with Browserbase provider.
...
- `hackernews-cdp-browserbase/` - Same example using raw CDP instead of Playwright
...
The scraper uses Playwright with Browserbase as the browser provider to:
