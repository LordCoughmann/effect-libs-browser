# Hacker News Playwright Scraper - Cloudflare Worker

A Hacker News scraper running on Cloudflare Workers using Playwright with a custom WebSocket URL.
...
- `hackernews-playwright-steel/` - Steel.dev provider
- `hackernews-playwright-browserbase/` - Browserbase provider
- `hackernews-playwright-cfBrowserRunBinding/` - Cloudflare Browser Run (native binding)

## See Also

- Alchemy variant: [`../cf-workers-alchemy/hackernews-playwright-wsUrl/`](../cf-workers-alchemy/hackernews-playwright-wsUrl/) — same scraper, deployed via [Alchemy](https://alchemy.run)
