...
- **CUA mode is hidden from Cloudflare Workers users who might benefit from it.** A user who wants Computer Use Agent on Workers has to read upstream Stagehand docs and figure out the credential plumbing themselves.
...
- [`CONTEXT.md`](../../../../CONTEXT.md) — the source-of-truth for terminology, anti-claims, and module scope.
- [`docs/packages/stagehand/index.md`](../../../packages/stagehand/index.md) — the module landing page; the `Not wrapped by design` table row links here.
...
- [`docs/contributing/cdp/decisions/0001-scraping-vs-testing-scope.md`](../../cdp/decisions/0001-scraping-vs-testing-scope.md) — sibling ADR style: "deliberate omissions" framing for a different module.
